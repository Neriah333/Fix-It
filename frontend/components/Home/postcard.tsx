...
// components/PostCard.tsx
export default function PostCard({ title, content, reactions, comments, author, createdAt }: any) {
  return (
    <div className="bg-[#1A282D] border border-[#2D3739] p-4 rounded-xl mb-3">
      {/* Header: Author info from your "UserAccount" ref */}
